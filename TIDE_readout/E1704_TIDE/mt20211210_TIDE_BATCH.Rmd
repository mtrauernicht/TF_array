...
```{r}
ref.file <- "/DATA/usr/m.trauernicht/projects/TF_array/data/TIDE/E1704_20211223/mt20211223_seq.txt"
output.file <- "/DATA/usr/m.trauernicht/projects/TF_array/data/TIDE/E1704_20211223/mt20211223_TIDE.pdf"
folder <- "/DATA/usr/m.trauernicht/projects/TF_array/data/TIDE/E1704_20211223/"
reporter_names <- c("NFYA", "Random", "TCF7L2", "STAT3", "NFE2L2")
seqstart = 2
seqend = 300
array_length = 4
```
