...
```{r}
ref.file <- "/DATA/usr/m.trauernicht/projects/TF_array/data/TIDE/E1485_20210401/mt20210401_seq.txt"
output.file <- "/DATA/usr/m.trauernicht/projects/TF_array/data/TIDE/E1485_20210401/mt20210401_TIDE.pdf"
folder <- "/DATA/usr/m.trauernicht/projects/TF_array/data/TIDE/E1485_20210401/"
reporter_names <- c("NFYA", "Random", "TCF7", "STAT3", "NRF2")
seqstart = 5
seqend = 80
array_length = 4
```
